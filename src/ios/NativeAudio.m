...
- (void)pluginInitialize
{
    ...
    // [vvip] // [session setActive: YES error: nil];
    // [vvip] // [session setCategory:AVAudioSessionCategoryPlayback error:nil];
}
